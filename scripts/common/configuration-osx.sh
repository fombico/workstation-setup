...
defaults write ~/Library/Preferences/.GlobalPreferences AppleShowScrollBars -string "Always"
defaults write ~/Library/Preferences/.GlobalPreferences AppleScrollerPagingBehavior -int 1
